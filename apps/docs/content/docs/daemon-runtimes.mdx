...
2. Detects AI coding tools installed on your `PATH` (6 built-in: [Claude Code](/providers#claude-code), [Codex](/providers#codex), [Cursor](/providers#cursor), [Copilot](/providers#copilot), [OpenCode](/providers#opencode), [Pi](/providers#pi))
...
- [Providers Matrix](/providers) — capability differences across the 6 AI coding tools
