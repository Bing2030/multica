...
You can also **manually subscribe** to any issue (even unrelated ones), or **manually unsubscribe** from any auto-subscription. Use the **Subscribers** control in the right panel on the issue page.
