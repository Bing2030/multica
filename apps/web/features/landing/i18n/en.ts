...
export function createEnDict(allowSignup: boolean): LandingDict {
  ...
  features: {
    ...
    runtimes: {
      ...
      description:
        "Local daemons and cloud runtimes, managed from a single panel. Real-time monitoring of online/offline status, usage charts, and activity heatmaps. Auto-detects 6 supported coding tools on your machine.",
      cards: [
        {
        ...
        },
        {
          ...
          description:
            "Multica scans for 6 supported coding tools \u2014 Claude Code, Codex, Cursor, Copilot, OpenCode, and Pi \u2014 and registers a runtime for each one it finds.",
        },
      ],
    },
  },
    ...
    items: [
      {
        ...
        answer:
          "Multica supports 6 coding tools out of the box: Claude Code, Codex, Cursor, Copilot, OpenCode, and Pi. The daemon auto-detects whichever CLIs you already have installed and registers a runtime for each one. Since it's open source, you can also add your own backends.",
      },
      {
