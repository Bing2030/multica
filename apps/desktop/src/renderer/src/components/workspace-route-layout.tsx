 ...
 *
 * THROWAWAY POC: under DevBypass the dev user always exists, so there is no
 * login redirect and no post-onboarding welcome modal. NEVER MERGE.
 */
export function WorkspaceRouteLayout() {
  ...
  }, [user, listFetched, workspace, wsList]);
